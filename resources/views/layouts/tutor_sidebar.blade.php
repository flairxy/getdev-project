        ...
        <nav id="sidebar">
            ...
            <div class="sidebar-content">
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        <li>
                            <a class="{{ request()->is('dashboard') ? ' active' : '' }}" href="/_dt/dashboard">
                                <i class="si si-cup"></i><span class="sidebar-mini-hide">Dashboard</span>
                            </a>
                        </li>
                        {{--
                        <li class="{{ request()->is('courses/*') ? ' open' : '' }}">
                        <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-notebook"></i><span
                                class="sidebar-mini-hide">Courses</span></a>
                        <ul>
                            <router-link to="" tag="li">
                                <a class="{{ request()->is('courses/approved') ? ' active' : '' }}"
                                    href="/_dt/courses/approved">Approved Courses</a>
                            </router-link>
                            <router-link to="" tag="li">
                                <a class="{{ request()->is('courses/approved') ? ' active' : '' }}"
                                    href="/_dt/courses/pending">Pending Courses</a>
                            </router-link>
                        </ul>
                        </li> --}}

                        <li class="{{ request()->is('messages/*') ? ' open' : '' }}">
                            <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-envelope"></i>
                                <span class="sidebar-mini-hide">Messages</span>
                                <span id="stats">
                                    <messages />
                                </span>
                            </a>
                            <ul>
                                ...
                                <router-link to="" tag="li">
                                    <a class="{{ request()->is('/messages/all') ? ' active' : '' }}"
                                        href="/_dt/messages/inbox">Inbox</a>
                                </router-link>
                                <router-link to="" tag="li">
                                    <a class="{{ request()->is('messages/sent') ? ' active' : '' }}"
                                        href="/_dt/messages/sent">Sent </a>
                                </router-link>
                            </ul>
                        </li>
                            ...
                            <ul>
                                <router-link to="" tag="li">
                                    <a class="{{ request()->is('earnings/invoices') ? ' active' : '' }}"
                                        href="/_dt/earnings/summary">Summary</a>
                                </router-link>
                                <router-link to="" tag="li">
                                    <a class="{{ request()->is('earnings/withdrawals') ? ' active' : '' }}"
                                        href="/_dt/earnings/withdrawals">Withdrawals</a>
                                </router-link>
                            </ul>
                        </li>

                    ...
                    <div class="content-side content-side-full content-side-user px-10 align-parent">
                        ...
                        <div class="sidebar-mini-hidden-b text-center">
                            <a class="img-link" href="javascript:void(0)">
                                {{-- @if($tutor->image)
                                    <img class="img-avatar" src="{{ asset('images/avatars') }}/{{ $tutor->image }}"
                                alt="">
                                @else --}}
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li>
                                ...
                                <ul>
                                    <router-link :to="{ name: 'mgt_staffs' }">Staffs
                                    </router-link>
                                    <router-link :to="{ name: 'mgt_students' }">
                                        Students
                                    </router-link>
                            ...
                            <li>
                                <router-link :to="{ name: 'AdminClass' }">

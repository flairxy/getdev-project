                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            @can('teacher')
                            <li>
                                <router-link :to="{ name: 'staff_TClass' }">
                                    <i class="si si-layers"></i><span class="sidebar-mini-hide">My Classes</span>
                                </router-link>

                            </li>
                            <li>
                                <router-link :to="{ name: 'staff_TStudents' }">
                                    <i class="si si-layers"></i><span class="sidebar-mini-hide">My Students</span>
                                </router-link>
                            ...
                            @can('conFin')
                            <li>
                                <router-link :to="{ name: 'staff_staffs' }">
                                    <i class="si si-layers"></i><span class="sidebar-mini-hide">Staffs</span>
                                </router-link>

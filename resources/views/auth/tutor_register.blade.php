        ...
        <div class="hero-static col-lg-6 col-xl-4">
            <div class="content content-full overflow-hidden">
                ...
                <div class="py-30 text-center">
                    ...
                    <h1 class="h4 font-w700 mt-30 mb-10">Sign up as a tutor</h1>
                    <h2 class="h5 font-w400 text-muted mb-0">We’re excited to have you on board!</h2>
                </div>

                <form class="js-validation-signin" method="POST" action="{{ route('tutorRegistration') }}"
                    ...
                    <div class="block block-rounded block-shadow">
                        ...
                        <div class="block-content">
                            ...
                            {{-- <div class="form-group row">
                                <label class="col-12">Upload ID (eg. driver's license,
                                    passport...)</label>
                                <div class="col-12">
                                    <div class="custom-file">
                                        <input type="file"
                                            class="custom-file-input js-custom-file-input-enabled @error('identity') is-invalid @enderror"
                                            id="example-file-input-custom" name="identity" accept="jpeg,png,jpg"

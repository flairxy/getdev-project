            ...
            <div class="dropdown-menu min-width-300" aria-labelledby="page-header-options-dropdown">
              ...
              <div class="row gutters-tiny text-center mb-5">
                <div class="col-6">
                  <button
                    type="button"
                    class="btn btn-sm btn-block btn-alt-secondary"
                    data-toggle="layout"
              ...
              <div class="row gutters-tiny text-center mb-5">
                <div class="col-6">
                  <button
                    type="button"
                    class="btn btn-sm btn-block btn-alt-secondary mb-10"
                    data-toggle="layout"
        ...
        <div class="content-header-section">
          ...
          <div class="btn-group" role="group">
            ...
            <div
              ...
              style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(97px, 34px, 0px);"
            ...
            >
              ...
              >
                <span>
                  <i class="si si-envelope-open mr-5"></i> Inbox
                </span>
          ...
          <div class="btn-group" role="group">
            ...
            <div
              ...
              style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(69px, 34px, 0px);"
              x-placement="bottom-end"
            >
              ...
              <ul class="list-unstyled my-20">
                ...
                <li>
                  <a class="text-body-color-dark media mb-15" href="javascript:void(0)">
                    ...
                    <div class="media-body pr-10">
                      <p class="mb-0">
                        Please consider upgrading your plan. You are running out of
                        space.
                      </p>
      ...
      <div id="page-header-search" class="overlay-header">
        <div class="content-header content-header-fullrow">
          <form action="/dashboard" method="POST">
            <input type="hidden" name="_token" value="iopIrKjj8Fxmeazki0JC7cV9zMNtU1BsWVdAan0E" />
